        ...
        TimerAction(
            ...
            actions=[
                IncludeLaunchDescription(
                    ...
                    launch_arguments={'map': os.path.expandvars('$HOME/ros2_ws/src/amr/map/demo_map.yaml')}.items(),
                ),
            ]
        ),
        ...
        TimerAction(
            ...
            actions=[
                Node(
                    ...
                    output='screen',
                    parameters=[{
                        'waypoints_file': '/home/st02/ros2_ws/src/robocup_navigator/params/demo_waypoint.yaml'
                    }],
                ),
            ]
        ),
