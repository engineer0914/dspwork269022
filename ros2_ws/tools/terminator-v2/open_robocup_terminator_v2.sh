...
CONFIG_FILE="$SCRIPT_DIR/terminator_robocup_8pane_v2.config"
GENERATED_CONFIG="/tmp/terminator_robocup_8pane_v2_${USER}.config"
...
exec terminator -u -g "$GENERATED_CONFIG" -l robocup_8pane_v2 "$@"
